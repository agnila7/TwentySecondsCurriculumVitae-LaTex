...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\skills{{Oral, written, interpersonal communication/5},{Critical Thinking, Problem solving/5},{MS office tool, Java, JavaScript, HTML,CSS/4.3},{Project Management/4},{Technical Support/4},{Operational Efficiency/5},{Administrative Task Management/5},{Customer Focus/4},{Accurate Processing/5}}
...
% Simple Section
\section{About Me}
Seeking to leverage organizational and technical skills to provide high-level customer support to this Reputed Company.
Graduated with honors in a Master of Applied Science program in Electrical Engineering from the University of Windsor. 
% Committed to fostering a diverse and inclusive workplace while ensuring efficient office operations and exceptional service.
